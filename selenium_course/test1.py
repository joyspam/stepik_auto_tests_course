...
try: 
    ...
    input4 = browser.find_element_by_class_name('second_block > .form-group > .form-control.first')
    input4.send_keys("78979879")
    input5 = browser.find_element_by_class_name('second_block > .form-group > .form-control.second')
